...
public class TreeService {
	...
	public List<Map<String, Object>> createTreeData(List<Map<String, Object>> datas, com.cxz.mushu.util.TreeInterface treeface){
		List<Map<String, Object>> roots = this.getChildren(datas, 0);
		this.loopChildren(roots, datas, treeface);
		return roots;
	}
	
	public List<Map<String, Object>> createTreeDataById(List<Map<String, Object>> datas, com.cxz.mushu.util.TreeInterface treeface, int id){
		List<Map<String, Object>> roots = this.getChildren(datas, id);
		this.loopChildren(roots, datas, treeface);
		return roots;
	}
	
	private void loopChildren(List<Map<String, Object>> nodes, List<Map<String, Object>> datas, com.cxz.mushu.util.TreeInterface treeface){
